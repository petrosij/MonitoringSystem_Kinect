...
if flag_nalichie == 0
%вырезаем цифру 1 для perf
perf1img =imcrop(BW,[fix((61*XLN)/471);fix((158*YLN)/374);fix((13*XLN)/471);fix((21*YLN)/374)] );
perf1imgBW = im2bw(perf1img);
%вырезаем цифру 2 для perf
